#!/bin/bash
#SBATCH --job-name=vit_l32_coupled_cifar100
...
echo "  Temperature Learning: K=3, Range=[0.1, 10.0], K=1 seed = 101"
echo ""
...
python ./CZnew4_LT_image_ddp.py \
    --data-dir ./data \
    --output-dir ./output_coupled_ddp_K3 \
    --epochs 50 \
    --batch-size 64 \
    --grad-accum-steps 2 \
    --grad-clip 1.0 \
...
echo ""
echo "Output files saved to: ./output_coupled_ddp_K3/"
