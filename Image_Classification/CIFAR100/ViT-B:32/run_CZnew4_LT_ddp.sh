#!/bin/bash
#SBATCH --job-name=vit_coupled_ddp
...
echo "=================================="
echo "ViT-B/32 CoupledModel DDP Training"
echo "=================================="
...
cd /home/spw5793/work/ZENN/Cifar100/ViT_B_32
...
echo "  Model: ViT-B/32 CoupledModel (Base, patch size 32)"
echo "  Dataset: CIFAR-10"
echo "  Pretrained Weights: ./pretrained_models/ViT-B_32.npz"
...
echo "  Temperature Learning: K=1, Range=[0.1, 10.0]"
echo ""
...
python CZnew4_LT_image_ddp.py \
    --data-dir ./data \
    --output-dir ./output_coupled_ddp_K1 \
    --epochs 50 \
    --batch-size 64 \
    --grad-accum-steps 2 \
    --grad-clip 1.0 \
    ...
    --seed 42 \
    --pretrained \
    --npz-path ./pretrained_models/ViT-B_32.npz
...
echo ""
echo "Output files saved to: ./output_coupled_ddp_K4/"
