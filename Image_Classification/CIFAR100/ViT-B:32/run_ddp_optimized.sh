#!/bin/bash
#SBATCH --job-name=vit_b32_cifar10
...
# Run DDP optimized training with ViT-B/32 model and ImageNet-21k pretrained weights
# Model: ViT-B/32 (88M parameters, patch size 32)
# Key optimizations:
...
python train_ddp_optimized.py \
    --data-dir ./data \
    --output-dir ./output_ddp_b32_in21k \
    --epochs 50 \
    --batch-size 64 \
    --grad-accum-steps 2 \
    --grad-clip 1.0 \
