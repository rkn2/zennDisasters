#!/bin/bash
#SBATCH --job-name=vit_coupled_ddp_c100
...
echo "=================================="
echo "ViT-L/16 CoupledModel DDP Training"
echo "=================================="
...
echo "  Model: ViT-L/16 CoupledModel"
echo "  Dataset: CIFAR-100"
echo "  Pretrained Weights: ./pretrained_models/ViT-L_16.npz"
...
python CZnew4_LT_image_ddp.py \
    ...
    --seed 100 \
    --pretrained \
    --npz-path ./pretrained_models/ViT-L_16.npz
...
echo ""
echo "Output files saved to: ./output_coupled_ddp_K1/"
