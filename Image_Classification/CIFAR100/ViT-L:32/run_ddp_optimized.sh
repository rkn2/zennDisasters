#!/bin/bash
#SBATCH --job-name=vit_l32_cifar100
...
cd /home/spw5793/work/ZENN/Cifar100/ViT_L_32
...
# Run DDP optimized training with ViT-L/32 model and ImageNet-21k pretrained weights
# Model: ViT-L/32 (Large, 307M parameters, patch size 32)
# Key optimizations:
...
python train_ddp_optimized.py \
    --data-dir ./data \
    --output-dir ./output_ddp_l32_in21k \
    --epochs 50 \
    --batch-size 64 \
    --grad-accum-steps 2 \
    --grad-clip 1.0 \
